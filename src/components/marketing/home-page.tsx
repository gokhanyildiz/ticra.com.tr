...
export function HomePage({ locale, dict }: HomePageProps) {
  const processCopy =
    locale === 'tr'
      ? {
          eyebrow: 'Kullanıma geçiş',
          title: 'Demo, hazırlık ve ekiplerinizle kullanım',
          pilotTitle: 'Kullanıma Hazırlık',
          pilotDescription:
            'İhtiyaç varsa gerçek verilerinizle kontrollü bir hazırlık adımı planlanır.',
          liveTitle: 'Canlı kullanım',
          liveDescription:
            'İhtiyaçlarınız netleşir, ekipleriniz için kullanım planı hazırlanır.',
        }
      : {
          eyebrow: 'Adoption path',
          title: 'Demo, preparation and team use',
          pilotTitle: 'Usage preparation',
          pilotDescription:
            'If needed, a controlled preparation step is planned with your real data.',
          liveTitle: 'Live use',
          liveDescription:
            'Your needs are clarified and a usage plan is prepared for your teams.',
        };
