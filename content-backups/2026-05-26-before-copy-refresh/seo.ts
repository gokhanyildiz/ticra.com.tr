...
const intentSeoCopy = {
  tr: {
    ...
    '/purchase': {
      title: 'Paket ve Firma Başına Kullanım İçin Teklif Al',
      description:
        'Basic, Professional veya Enterprise kapsamınızı; kullanıcı, firma başına kullanım, depolama, modül ve entegrasyon ihtiyacınıza göre tekliflendirin.',
    },
  },
  en: {
    '/': {
      ...
      description:
        'Ticra brings quotes, orders, inventory, purchasing, finance, projects, technical service, HR, documents, contracts and multi-firm workflows into one workspace.',
    },
    '/features': {
    ...
    '/purchase': {
      title: 'Request a Quote by Package and Per-Firm Use',
      description:
        'Share your Basic, Professional or Enterprise target, user count, per-firm use, storage, module and integration needs for a tailored quote.',
    },
  },
...
function planOfferDescription(
  ...
  if (plan.code === 'ENTERPRISE') {
    return locale === 'tr'
      ? 'Enterprise paketi kurumsal kapsam ve özel fiyat teklifiyle sunulur.'
      : 'The Enterprise package is provided with corporate scope and custom quote terms.';
  }

  const userBasedNote =
    locale === 'tr'
      ? 'Kullanıcı başı aylık paket kapsamı için teklif alın.'
      : 'Request a quote for the monthly per-user package scope.';
